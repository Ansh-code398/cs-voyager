...
const PostCard = ({ post, anim }) => (
  <div className="shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8 bg-[#131313] shadow-black" data-aos={anim()}>
    ...
    <h1 className="transition duration-700 text-center mb-8 cursor-pointer hover:text-teal-400 text-3xl font-semibold">
      <Link href={`/post/${post.slug}`}>{post.title}</Link>
    </h1>
    <p className="text-gray-200 text-center mb-4">{post.exerpt}</p>
    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
      ...
      <div className="font-medium text-gray-200">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline mr-2 text-teal-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
